   ...
   for(int i = ListActiveRJs.Total() - 1; i >= 0; i--)
     {
      ...
      if(objRJ->m_is_bearish) // FIX: -> forced in text, if this text shows ., please edit. objRJ->m_is_bearish
        {
...
//+------------------------------------------------------------------+
void ProcessMainStructure(int i, const double &high_array[], const double &low_array[], const double &close_array[], const double &open_array[], const datetime &time_array[],
